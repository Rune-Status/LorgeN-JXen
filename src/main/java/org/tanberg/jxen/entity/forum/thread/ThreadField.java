...
public class ThreadField {
    ...
    private String[] matchParams; // Unconfirmed type
    ...
    public ThreadField(String fieldId, String title, String description, int displayOrder, String fieldType,
                       GenericEntity fieldChoices, String matchType, String[] matchParams, int maxLength,
                       boolean required, String displayGroup) {
